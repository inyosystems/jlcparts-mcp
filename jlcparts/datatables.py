    ...
    try:
        if key in ["resistance @ 25°c"] and compoundValue(value):
            ...
            value = attributes.voltageRangeAttribute(value, "voltage")
                ...
                "Low Level Range (VIL)", "Low Level Range (VOL)"]):
            ...
            if key == "drain current (idss@vds,vgs=0)":
                ...
                "Dissipation Power", "Corresponding Power", "Power Capacity", "Power Rating",
            ...
            value = attributes.identifierListAttribute(value, "level standard", aliases=SIGNAL_LEVEL_ALIASES)
        ...
        elif key in larr(["Illumination Color", "Color", "Actuator/Cap Color", "Actuator Color", "Detection Color", "Jacket Color", "Plastic Color"]):
        ...
        elif key in larr(["SPI", "UART/Usart", "I2C", "I2s", "8bit Timer", "16bit Timer", "32bit Timer", "CAN"]):
            value = attributes.countAttribute(value)
            ...
            elif key in larr(["Length", "Width", "Height", "Overall Length"]) and isinstance(value, str) and ("," in value or ";" in value):
            ...
            value = attributes.inductanceAtFrequencyListAttribute(value) if compoundValue(value) else attributes.inductanceAtFrequency(value)
            ...
            if compoundValue(value) and "@" not in value:
                if key in larr(["Propagation Delay", "Propagation Delay (TPD)", "Propagation Delay Time", "Turn-On Time", "Turn-Off Time",
                        "Rise Time", "Reset Timeout", "Settling Time", "Response Time (Tr)", "Time to Trip (Max)", "Td(Off)",
